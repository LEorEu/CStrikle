#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""抓 5eplay 的选手当前竞技数据 -> data/blind_draft/5e_player_stats.json（本地维护工具）。
...
from playerdb.paths import BLIND_DRAFT, ROOT

CARDS_PATH = BLIND_DRAFT / "draft_cards.json"
OUT_PATH = BLIND_DRAFT / "5e_player_stats.json"
ALIAS_PATH = BLIND_DRAFT / "5e_aliases.json"
IDS_CACHE = ROOT / ".cache" / "5e" / "player_ids.json"
SNAP_PATH = BLIND_DRAFT / "team_snapshot.json"
FIELD_PATH = BLIND_DRAFT / "major_field.json"
...
def main():
    ...
    if miss:
        print("  对不上的 %d 人（在 data/blind_draft/5e_aliases.json 里补别名）：\n     %s"
