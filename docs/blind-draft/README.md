...
| 3 | [卡牌与落地记录.md](卡牌与落地记录.md) | 647 张选手卡怎么生成的（v7：火力已与 Grade 解耦）、实现时和蓝图差在哪、用真实数据核对的数字 | 要改卡库或生成器之前 |
...
| 9 | [FribergCS2_Draft_四维重构工作指南_v0.1.md](FribergCS2_Draft_四维重构工作指南_v0.1.md) | v7 重构的执行口径：Grade / Firepower / Experience / Stability 各管什么，分几个 Phase 做，本轮明确禁止做什么 | **动四维之前先看它** |
