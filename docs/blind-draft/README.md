...
| 5 | [比赛引擎_v0.1.md](比赛引擎_v0.1.md) | 把这五个人放进一届真实 Major 的瑞士轮。§44~§48 是已经跑出来的数和据此改掉的设计，§47 是几个悬案的结论，§48 是拿真实阵容试跑撞出来的，§49 修了 AI 层违反卡库规矩的那处，§50 是补位，§51 记的是「当前实力」这条线的三次尝试和找到的真值数据源 | 现在 |
