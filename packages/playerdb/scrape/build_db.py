...
Usage:
  python playerdb/build_db.py            # full build -> data/players.json
  python playerdb/build_db.py --no-blast # skip blast.tv merge
"""
import argparse
import json
import re
...
# ---------------------------------------------------------------- regions
# 表在 playerdb/regions.py:管理页新增选手也要推赛区,而 scraper/ 不进镜像。
from ..regions import REGION, region_of  # noqa: E402,F401
